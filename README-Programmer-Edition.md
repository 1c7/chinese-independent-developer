...
* :white_check_mark: [LunaSwapping](https://github.com/loxi-opensource/luna-swapping)：开源的AI换脸应用解决方案。1张照片快速生成高质量AI写真照，出图效果对标妙鸭相机。一站式AI换脸系统，提供小程序端、服务端、管理后全套代码。后台内置10w+高清写真模板，可自定义模板管理。提供基础AI换脸能力，可构建等多场景玩法。
