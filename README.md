...
#### 制作者名字 - [Github](链接)
* :white_check_mark: [ZestyGen](https://zesty gen.com/)：用途：基于nano banana pro聚合图片和视频内容。
...
* 社区类网站（v2ex，ruby-china，各种 php 社区，太多太多太多了。没法收。希望理解）。

### 流程
看了评论后会做决定。如果入了，会加进去。如果没入，会告知你理由（希望你不要介意 :)，也许你可以开一个专门针对那个领域的 list）。

### 备注
24 小时内肯定回复。

### 建议
附上自己的 Github 或微博或博客地址。（表里有例子的，可以参考）。每个项目的后面可以放个 [更多介绍] 链到你的博客，博客里可以聊更多情况，包括为什么做，现状如何。
