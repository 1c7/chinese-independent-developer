...
* :white_check_mark: [hyperlane](https://github.com/euv-dev/hyperlane)：基于 Tokio 的轻量、高性能、跨平台 Rust HTTP 服务器库，内置中间件、WebSocket、SSE 与原始 TCP 支持 - [查看仓库](https://github.com/euv-dev/hyperlane) - [crates.io](https://crates.io/crates/hyperlane)
...
* :white_check_mark: [AI-ROUTER](https://ai-router.dev/cn/)：面向开发者的第三方 ChatGPT API 中转服务，兼容 OpenAI 调用方式，可创建 API Key 并查看各 Key 用量；新用户可获总计 20U 体验额度，其中 5U 注册即用，15U 充值后等额解锁
