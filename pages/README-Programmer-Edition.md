...
* :white_check_mark: [mcpp](https://github.com/mcpp-community/mcpp)：一个 **现代 C++ 模块化构建工具** — 纯 C++23 模块编写(已实现自举), 推动C++进入`import std`时代 - [模块化库集合](https://github.com/mcpplibs) / [包索引](https://mcpplibs.github.io/mcpp-index/)
